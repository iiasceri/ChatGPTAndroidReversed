...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v2, p1, p2}, Landroidx/appcompat/widget/o3;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    invoke-virtual {v2, v3}, Landroidx/appcompat/widget/o3;->e(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    sget-object v0, Le3/y0;->a:Ljava/util/WeakHashMap;

    invoke-static {p0, p1}, Le3/h0;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    const/4 p1, 0x5

    invoke-virtual {v2, p1, v3}, Landroidx/appcompat/widget/o3;->i(II)I
    ...
    invoke-virtual {v2, p1, p2}, Landroidx/appcompat/widget/o3;->i(II)I
...
.method public final c(Lj/b;)V
    ...
    invoke-direct {v2, p0, p1}, Landroidx/appcompat/widget/c;-><init>(Landroidx/appcompat/widget/ActionBarContextView;Lj/b;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lj/b;->c()Lk/o;

    move-result-object p1

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->y:Landroidx/appcompat/widget/m;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->y:Landroidx/appcompat/widget/m;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->y:Landroidx/appcompat/widget/m;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->w:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Lk/o;->b(Lk/c0;Landroid/content/Context;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->y:Landroidx/appcompat/widget/m;

    iget-object v2, p1, Landroidx/appcompat/widget/m;->C:Lk/e0;

    if-nez v2, :cond_3

    iget-object v3, p1, Landroidx/appcompat/widget/m;->y:Landroid/view/LayoutInflater;

    iget v4, p1, Landroidx/appcompat/widget/m;->A:I
    ...
    iput-object v1, p1, Landroidx/appcompat/widget/m;->C:Lk/e0;

    iget-object v3, p1, Landroidx/appcompat/widget/m;->x:Lk/o;
    ...
    :cond_3
    iget-object v1, p1, Landroidx/appcompat/widget/m;->C:Lk/e0;
    ...
    invoke-static {v1, p1}, Le3/h0;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final g(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p1, Landroidx/appcompat/widget/m;->w:Landroid/content/Context;

    new-instance v1, Lm9/h;

    const/4 v2, 0x1

    invoke-direct {v1, v0, v2}, Lm9/h;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v1}, Lm9/h;->c()I

    move-result v0

    iput v0, p1, Landroidx/appcompat/widget/m;->K:I
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->A:Le3/i1;
...
.method public final l(JI)Le3/i1;
    .locals 3
    ...
    :cond_1
    invoke-static {p0}, Le3/y0;->a(Landroid/view/View;)Le3/i1;
    ...
    invoke-virtual {v1, p1, p2}, Le3/i1;->c(J)V

    iget-object p1, v0, Landroidx/appcompat/widget/a;->c:Landroidx/appcompat/widget/ActionBarContextView;

    iput-object v1, p1, Landroidx/appcompat/widget/ActionBarContextView;->A:Le3/i1;

    iput p3, v0, Landroidx/appcompat/widget/a;->b:I

    invoke-virtual {v1, v0}, Le3/i1;->d(Le3/j1;)V
    ...
    invoke-virtual {v2, v1}, Le3/i1;->a(F)V

    invoke-virtual {v2, p1, p2}, Le3/i1;->c(J)V

    iget-object p1, v0, Landroidx/appcompat/widget/a;->c:Landroidx/appcompat/widget/ActionBarContextView;

    iput-object v2, p1, Landroidx/appcompat/widget/ActionBarContextView;->A:Le3/i1;

    iput p3, v0, Landroidx/appcompat/widget/a;->b:I

    invoke-virtual {v2, v0}, Le3/i1;->d(Le3/j1;)V
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, Le3/y0;->n(Landroid/view/View;Ljava/lang/CharSequence;)V
