...
.method public static constructor <clinit>()V
    ...
    sget-object v2, Lol/shPI/bIakuZTZ;->tBHCndnjQwZBnO:Ljava/lang/String;

    invoke-static {v0, v1, v2}, Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;->newUpdater(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;

    move-result-object v1

    sput-object v1, Lgk/m;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lgk/m;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    invoke-direct {v0, v3, v1, v2}, Landroidx/emoji2/text/u;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lgk/m;->g:Landroidx/emoji2/text/u;
...
.method public constructor <init>(IZ)V
    ...
    iput p1, p0, Lgk/m;->a:I

    iput-boolean p2, p0, Lgk/m;->b:Z
    ...
    iput-object v0, p0, Lgk/m;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final a(Ljava/lang/Object;)I
    ...
    :cond_0
    sget-object v8, Lgk/m;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    :cond_3
    iget-boolean v4, v6, Lgk/m;->b:Z

    iget-object v15, v6, Lgk/m;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-virtual {v0}, Lgk/m;->c()Lgk/m;

    move-result-object v0

    iget-object v1, v0, Lgk/m;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v2, v0, Lgk/m;->c:I
    ...
    instance-of v9, v5, Lgk/l;

    if-eqz v9, :cond_7

    check-cast v5, Lgk/l;

    iget v5, v5, Lgk/l;->a:I
...
.method public final b()Z
    ...
    :cond_0
    sget-object v0, Lgk/m;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public final c()Lgk/m;
    .locals 10

    :cond_0
    sget-object v6, Lgk/m;->f:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    :goto_0
    sget-object v0, Lgk/m;->e:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    iget v4, p0, Lgk/m;->a:I

    mul-int/lit8 v4, v4, 0x2

    iget-boolean v5, p0, Lgk/m;->b:Z

    invoke-direct {v1, v4, v5}, Lgk/m;-><init>(IZ)V
    ...
    iget-object v7, p0, Lgk/m;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    new-instance v7, Lgk/l;

    invoke-direct {v7, v4}, Lgk/l;-><init>(I)V

    :cond_3
    iget-object v8, v1, Lgk/m;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v9, v1, Lgk/m;->c:I
...
.method public final d()Ljava/lang/Object;
    ...
    sget-object v0, Lgk/m;->g:Landroidx/emoji2/text/u;
    ...
    :cond_2
    iget-object v4, v6, Lgk/m;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v4, v14}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v5

    iget-boolean v9, v6, Lgk/m;->b:Z
