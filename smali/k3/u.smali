...
# virtual methods
.method public final a(Landroid/view/View;Le3/h;)Le3/h;
    .locals 9
    ...
    :cond_0
    iget-object v0, p2, Le3/h;->a:Le3/g;

    invoke-interface {v0}, Le3/g;->g()I
    ...
    :cond_1
    iget-object p2, p2, Le3/h;->a:Le3/g;

    invoke-interface {p2}, Le3/g;->d()Landroid/content/ClipData;

    move-result-object v0

    invoke-interface {p2}, Le3/g;->k()I
