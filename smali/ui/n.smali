...
.field public static final z:Lui/n;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lui/n;->A:Lui/a;

    new-instance v0, Lui/n;

    invoke-direct {v0}, Lui/n;-><init>()V

    sput-object v0, Lui/n;->z:Lui/n;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lui/n;->x:B

    iput v0, p0, Lui/n;->y:I

    sget-object v0, Laj/g;->v:Laj/x;

    iput-object v0, p0, Lui/n;->v:Laj/g;
...
.method public constructor <init>(Laj/h;Laj/k;)V
    ...
    iput-object v0, p0, Lui/n;->w:Ljava/util/List;
    ...
    iput-object v5, p0, Lui/n;->w:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_2
    iget-object v5, p0, Lui/n;->w:Ljava/util/List;

    sget-object v6, Lui/r;->E:Lui/a;
    ...
    iget-object p2, p0, Lui/n;->w:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lui/n;->w:Ljava/util/List;
    ...
    iput-object p2, p0, Lui/n;->v:Laj/g;
    ...
    iget-object p1, p0, Lui/n;->w:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lui/n;->w:Ljava/util/List;
    ...
    iput-object p1, p0, Lui/n;->v:Laj/g;
...
.method public final a()Z
    ...
    :goto_0
    iget-object v3, p0, Lui/n;->w:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lui/r;->a()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lui/n;->x:B
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, Lui/n;->w:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lui/n;->v:Laj/g;
...
.method public final e()Laj/b;
    ...
    invoke-virtual {v0, p0}, Lui/m;->j(Lui/n;)V
...
.method public final f(Laj/i;)V
    ...
    invoke-virtual {p0}, Lui/n;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lui/n;->w:Ljava/util/List;
